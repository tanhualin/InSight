alter PROC [dbo].[spApp_GetYLOrdersNormal_BFMX_OPP]
	@ordID INT
	,@pageName NVARCHAR(50)=N'包覆门芯'
...
BEGIN
	...
	JOIN dbo.ItemItemFamilies itmItemF (NOLOCK) ON itmItemF.itmID = t.itmID AND itmItemF.itmfCode =N'BFMKM_MX'
	OUTER APPLY
	(
		SELECT 
