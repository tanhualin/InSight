...
alter PROC [dbo].[spApp_GetYLOrdersNormal_KQGNJ_OPP]
	@ordID INT
	,@pageName NVARCHAR(10)=N'烤漆功能件'
...
BEGIN
	...
	JOIN dbo.CustomizedItemFamily_Opp cz (NOLOCK) on cz.scode =itmf.itmfCode AND cz.ReportType=6     
	OUTER APPLY
	(  
		Select 
