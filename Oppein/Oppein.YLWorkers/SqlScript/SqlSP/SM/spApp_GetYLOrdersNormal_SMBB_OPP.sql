...
ALTER PROC [dbo].[spApp_GetYLOrdersNormal_SMBB_OPP]
	@ordID INT
...
BEGIN
	...
	--LEFT JOIN dbo.ItemAttributeValues iatbv(NOLOCK) ON iatbv.itmID = t.itmID AND iatbv.atbID = 362
	...
	WHERE mr.mtpCode=N'Sheet Stock Solid'
